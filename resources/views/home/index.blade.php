...
<!-- banner -->
            ...
            <script src="{{asset('home/js/responsiveslides.min.js')}}"></script>
					 <script>
						...
						$(function () {
                          ...
                          function slideShow(slides){
                              for(i in slides){
                                  $("#image_" + slides[i].id).css("background", 'url(' + slides[i].image_url + ') no-repeat center top');
                              }
					...
					<div  id="top" class="callbacks_container">
						<ul class="rslides" id="slider3">
							...
							<li>
								<div class="banner-bg" id="{{ 'image_'.$slide['id'] }}">
									<div class="container">
										<div class="banner-info">
                                            <h3> {{ $slide['title'] }} </h3>
                                            <p> {{ $slide['content'] }} </p>
                                            <a href="{{ route('course.show', ['id' => $slide['course_id']]) }}"><i class="fa fa-thumbs-up icon_1" style="font-size: 20px; transition: color 0.2s ease 0s, border-color 0.2s ease 0s, background-color 0.2s ease 0s; min-height: 0px; min-width: 0px; line-height: 20px; border-width: 0px 2px 0px 0px; margin: 0px; padding:0px 10px 0 0; letter-spacing: 0px;"></i>查看课程</a>
										</div>
									</div>
								</div>
							</li>
			  ...
			  <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
			    <div class="events_box">
			    	...
			    	<div class="event_right">
						  ...
						  <img src="home/images/t9.jpg" class="img-responsive" alt=""/>	
		    	    </div>
		    	    <div class="clearfix"></div>
			   </div>
			   <div class="events_box">
			    	...
			    	<div class="event_right">
						  ...
						  <img src="home/images/t5.jpg" class="img-responsive" alt=""/>	
		    	    </div>
		    	    <div class="clearfix"></div>
			   </div>
			  </div>
			  <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
			    <div class="events_box">
			    	...
			    	<div class="event_right">
			    		  <h3><a href="#">Welcoming and introduction</a></h3>
						  <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form <a href="#">Read More</a></p>
						  <img src="home/images/t8.jpg" class="img-responsive" alt=""/>	
		    	    </div>
		    	    <div class="clearfix"></div>
			   </div>
			   <div class="events_box">
			    	...
			    	<div class="event_right">
						  ...
						  <img src="home/images/t2.jpg" class="img-responsive" alt=""/>	
		    	    </div>
		    	    <div class="clearfix"></div>
			   </div>
			</div>
			<div role="tabpanel" class="tab-pane fade" id="profile1" aria-labelledby="profile-tab1">
			    <div class="events_box">
			    	...
			    	<div class="event_right">
						  ...
						  <img src="home/images/t7.jpg" class="img-responsive" alt=""/>	
		    	    </div>
		    	    <div class="clearfix"></div>
			   </div>
			   <div class="events_box">
			    	...
			    	<div class="event_right">
						  ...
						  <img src="home/images/t4.jpg" class="img-responsive" alt=""/>	
		    	    </div>
		    	    <div class="clearfix"></div>
			    </div>
			   </div>
   ...
   <div class="bottom_content">  
     ...
     <div class="grid_2">
     	<div class="col-md-4 portfolio-left">
            <div class="portfolio-img event-img">
                <img src="home/images/t15.jpg" class="img-responsive" alt=""/>
        ...
        <div class="col-md-4 portfolio-left">
            <div class="portfolio-img event-img">
                <img src="home/images/t10.jpg" class="img-responsive" alt=""/>
                 <div class="over-image"></div>
            </div>
            <div class="portfolio-description">
               <h4><a href="#">Lorem Ipsum</a></h4>
        ...
        <div class="col-md-4 portfolio-left">
            <div class="portfolio-img event-img">
                <img src="home/images/t12.jpg" class="img-responsive" alt=""/>
                 <div class="over-image"></div>
            </div>
            <div class="portfolio-description">
               <h4><a href="#">Lorem Ipsum</a></h4>
     ...
     <div class="grid_3">
     	<div class="col-md-4 portfolio-left">
            <div class="portfolio-img event-img">
                <img src="home/images/t11.jpg" class="img-responsive" alt=""/>
                 <div class="over-image"></div>
            </div>
            <div class="portfolio-description">
               <h4><a href="#">Lorem Ipsum</a></h4>
        ...
        <div class="col-md-4 portfolio-left">
            <div class="portfolio-img event-img">
                <img src="home/images/t14.jpg" class="img-responsive" alt=""/>
                 <div class="over-image"></div>
            </div>
            <div class="portfolio-description">
               <h4><a href="#">Lorem Ipsum</a></h4>
        ...
        <div class="col-md-4 portfolio-left">
            <div class="portfolio-img event-img">
                <img src="home/images/t13.jpg" class="img-responsive" alt=""/>
                 <div class="over-image"></div>
            </div>
            <div class="portfolio-description">
               <h4><a href="#">Lorem Ipsum</a></h4>
