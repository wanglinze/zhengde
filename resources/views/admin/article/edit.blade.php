...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{route('admin.home')}}">首页</a> &raquo; 文章管理
    </div>
    <!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        <form id="submit_form" action="{{route('article.update', ['id' => $field->art_id])}}" method="post">
        ...
        $(document).ready(function () {
            ...
            var options = {
                success: function (data) {
                    $("#error_message").empty();
                    var submit_url = '{{route("article.update",["id" => $field->art_id])}}'
