...
@section('content')
    ...
    <div class="result_wrap">
        <form id="submit_form" action="{{route('staff.update', ['id' => $field->id])}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    <th></th>
                    <td>
                        <img src="{{$field->image}}" alt="" id="upload_img" style="max-width: 700px; max-height:350px;">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th> QQ：</th>
                    <td>
                        <input type="text" class="md" name="qq" value="{{$field->qq}}">
                    </td>
                </tr>
                <tr>
                    <th><i class="require">*</i> 简介：</th>
                    <td>
                        <textarea name="description">{{$field->name}}</textarea>
                    </td>
                </tr>
                <tr>
        ...
        $(document).ready(function () {
            ...
            var options = {
                success: function (data) {
                    $("#error_message").empty();
                    var submit_url = '{{route('staff.update', ['id' => $field->id])}}'
