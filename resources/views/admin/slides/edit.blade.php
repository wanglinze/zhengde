...
@section('content')
    ...
    <div class="result_wrap">
        <form id="submit_form" action="{{route('slides.update', ['id' => $field->id])}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    <th> 链接：</th>
                    <td>
                        <input type="text" class="lg" name="redirect_url"  value="{{$field->redirect_url}}">
                    </td>
                </tr>
        ...
        $(document).ready(function () {
            ...
            var options = {
                success: function (data) {
                    $("#error_message").empty();
                    var submit_url = '{{route("slides.update", ['id' => $field->id])}}'
