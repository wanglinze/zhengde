            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <select name="type" id="course_type">
                            <option value="normal" selected="selected">长期</option>
                ...
                <tr id="normal_time">
                    ...
                    <td>
                        ...
                        <span style="cursor:pointer" onclick="add_item()">[+ 添加]</span>
                    </td>
                </tr>
        ...
        function add_item(){
            ...
            var newText = ''+
                '<tr>'+
                    '<th></th>'+
                    '<td>'+
                        '<select name="normal[' + random_key + '][week]" class="sm">'+
                            '<option value="1" selected="selected">星期一</option>'+
                            '<option value="2">星期二</option>'+
                            '<option value="3">星期三</option>'+
                            '<option value="4">星期四</option>'+
                        ...
                        '</select>'+
                        '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>起止时间：</span>&nbsp;&nbsp;&nbsp;'+
                        '<input id="' + start_time_id + '" type="text" class="sm" name="normal[' + random_key + '][start_time]">'+
                        '&nbsp;&nbsp;-&nbsp;&nbsp;'+
                        '<input id="' + end_time_id + '" type="text" class="sm" name="normal[' + random_key + '][end_time]">'+
